...
For example, when Gigi has 9 tiles she can use them all to build a square whose side length is 3. But when she has only 8 tiles, 
the largest square that she can build has side length 2.
...
print("The largest square has side length" + ' ' + str(int(sqrt(int(input()))))+".")
